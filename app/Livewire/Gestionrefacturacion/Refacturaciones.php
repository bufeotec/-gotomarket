...
namespace App\Livewire\Gestionrefacturacion;
...
class Refacturaciones extends Component
{
    ...
    public function render(){
        ...
        return view('livewire.gestionrefacturacion.refacturaciones', compact('refac', 'listar_departamento', 'listar_refactura'));
    }
    ...
    public function cargar_datos_factura(){
        if ($this->id_despacho_venta) {
            ...
            if ($factura) {
                ...
                // Cargar las provincias y distritos en base al departamento y provincia seleccionados
