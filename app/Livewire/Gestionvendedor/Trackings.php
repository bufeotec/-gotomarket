...
class Trackings extends Component
{
    ...
    public function buscar() {
        ...
        $preProgramado = Facturaspreprogramacion::where('fac_pre_prog_cfnumdoc', $this->search_compro)->first();
        ...
        if ($preProgramado) {
            ...
            $historial = Historialpreprogramacion::where('fac_pre_prog_cfnumdoc', $this->search_compro)
        ...
        $despachoVenta = DespachoVenta::where('despacho_venta_cfnumdoc', $this->search_compro)->first();
        ...
        $historialDespachoVentaEtapa3 = Historialdespachoventa::where('despacho_venta_cfnumdoc', $this->search_compro)
