...
--
-- Host: localhost:3306
-- Generation Time: Oct 08, 2024 at 02:37 PM
...
('admin|127.0.0.1', 'i:2;', 1728050438),
('admin|127.0.0.1:timer', 'i:1728050438;', 1728050438),
...
(5, '10740779759', 1460, 'APAGUEÑO REYNA EDER ALFREDO', 'Calle las Americas 457', 'alfredev', '956449198', '956449198', 'reynaalfredo421@gmail.com', 'puntostyle@gmail.com', 'Desarrollo de software', NULL, NULL, NULL, NULL, NULL, 0, 1, 1, '2024-09-24 12:35:29', '2024-09-25 03:13:02');
...
(26, 'Configuración', 'configuracion', 'fa-solid fa-gear', 1, 1, 1, '1725331940.4755', '2024-09-03 02:52:20', '2024-10-04 22:15:04'),
(28, 'Gestión de transporte', 'Gestiontransporte', 'fa fa-truck-moving', 2, 1, 1, '1728062742.1812', '2024-10-04 22:25:42', '2024-10-05 03:46:21');
...
(22, '2024_10_04_200634_create_tipo_servicios_table', 11),
(23, '2024_10_04_200707_create_transportistas_table', 11),
(24, '2024_10_07_214131_create_tipo_vehiculos_table', 12),
(25, '2024_10_07_214139_create_vehiculos_table', 12);
...
(61, 28, NULL, 'Gestiontransporte', 'web', 1, 28, 1, '2024-10-04 22:25:42', '2024-10-04 22:25:42'),
(62, NULL, 8, 'transportistas', 'web', 2, 8, 1, '2024-10-04 22:35:54', '2024-10-04 22:35:54'),
(65, NULL, NULL, 'crear_servicios', 'web', 3, 8, 1, '2024-10-05 02:18:12', '2024-10-05 02:18:12'),
(66, NULL, NULL, 'disable_servicio', 'web', 3, 8, 1, '2024-10-05 03:16:52', '2024-10-05 03:16:52'),
(67, NULL, NULL, 'create_transportistas', 'web', 3, 8, 1, '2024-10-05 05:56:28', '2024-10-05 05:56:28'),
(68, NULL, NULL, 'update_transportistas', 'web', 3, 8, 1, '2024-10-06 07:57:35', '2024-10-06 07:57:35'),
(69, NULL, NULL, 'disable_transportistas', 'web', 3, 8, 1, '2024-10-06 08:05:55', '2024-10-06 08:05:55'),
(70, NULL, 9, 'vehiculos', 'web', 2, 9, 1, '2024-10-08 02:54:18', '2024-10-08 03:28:36'),
(71, NULL, NULL, 'crear_tipo_vehiculo', 'web', 3, 9, 1, '2024-10-08 04:42:31', '2024-10-08 04:42:31'),
(72, NULL, NULL, 'disable_tipo_vehiculo', 'web', 3, 9, 1, '2024-10-08 04:52:18', '2024-10-08 04:52:18'),
(73, NULL, NULL, 'create_vehiculo', 'web', 3, 9, 1, '2024-10-08 07:02:54', '2024-10-08 07:02:54'),
(74, NULL, NULL, 'update_vehiculos', 'web', 3, 9, 1, '2024-10-08 19:17:56', '2024-10-08 19:17:56'),
(75, NULL, NULL, 'disable_vehiculo', 'web', 3, 9, 1, '2024-10-08 19:24:56', '2024-10-08 19:24:56');
...
(1, 'Nivel 0', 'web', 1, '2024-09-02 03:08:24', '2024-10-04 18:06:56'),
(2, 'Nivel 1', 'web', 1, NULL, '2024-10-04 18:07:02'),
(3, 'Nivel 2', 'web', 1, '2024-09-09 02:58:05', '2024-10-04 18:07:10'),
(4, 'Nivel 3', 'web', 1, '2024-10-04 18:07:18', '2024-10-04 18:07:18');
...
('ujqDXzOWoiqAsqGQYNhSUaMwW4q0Vm4serYlqLsj', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/129.0.0.0 Safari/537.36', '', 1728047605);
...
(7, 26, 'Empresas', 'empresas', 5, 1, 1, '1726666288.2756', '2024-09-18 13:31:28', '2024-09-18 13:31:28'),
(8, 28, 'Transportistas', 'transportistas', 1, 1, 1, '1728063354.0353', '2024-10-04 22:35:54', '2024-10-04 22:38:01'),
(9, 28, 'Vehiculos', 'vehiculos', 2, 0, 1, '1728338058.0826', '2024-10-08 02:54:18', '2024-10-08 03:28:36');
...
CREATE TABLE `tipo_servicios` (
  `id_tipo_servicios` bigint UNSIGNED NOT NULL,
  `id_users` bigint UNSIGNED NOT NULL,
  `tipo_servicio_concepto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_servicio_estado` tinyint NOT NULL,
  `tipo_servicio_microtime` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tipo_servicios` (`id_tipo_servicios`, `id_users`, `tipo_servicio_concepto`, `tipo_servicio_estado`, `tipo_servicio_microtime`, `created_at`, `updated_at`) VALUES
(1, 1, 'Prueba 1', 1, '1728182740.1696', '2024-10-06 07:45:40', '2024-10-07 21:41:00'),
(2, 1, 'Prueba 2', 1, '1728183665.7999', '2024-10-06 08:01:05', '2024-10-07 21:41:02'),
(3, 1, 'Prueba 3', 1, '1728310987.541', '2024-10-07 19:23:07', '2024-10-07 21:41:02'),
(4, 1, 'Prueba 4', 1, '1728344724.9996', '2024-10-08 04:45:25', '2024-10-08 04:45:25'),
(5, 1, 'Prueba 5', 1, '1728349864.5358', '2024-10-08 06:11:04', '2024-10-08 06:11:04');
...
CREATE TABLE `tipo_vehiculos` (
  ...
  `id_users` bigint UNSIGNED NOT NULL,
  `tipo_vehiculo_concepto` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `tipo_vehiculo_estado` tinyint NOT NULL,
  `tipo_vehiculo_microtime` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `tipo_vehiculos` (`id_tipo_vehiculo`, `id_users`, `tipo_vehiculo_concepto`, `tipo_vehiculo_estado`, `tipo_vehiculo_microtime`, `created_at`, `updated_at`) VALUES
(1, 1, 'carro grande', 1, '1728344921.6985', '2024-10-08 04:48:41', '2024-10-08 19:15:44'),
(2, 1, 'carro grande 2', 1, '1728344996.5834', '2024-10-08 04:49:56', '2024-10-08 04:49:56'),
(3, 1, 'carro grande 3', 1, '1728349066.2812', '2024-10-08 05:57:46', '2024-10-08 05:57:46');
...
CREATE TABLE `transportistas` (
  `id_transportistas` bigint UNSIGNED NOT NULL,
  `id_users` bigint UNSIGNED NOT NULL,
  `id_tipo_servicios` bigint UNSIGNED NOT NULL,
  `id_ubigeo` bigint UNSIGNED NOT NULL,
  `transportista_ruc` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transportista_razon_social` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transportista_nom_comercial` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `transportista_direccion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transportista_correo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transportista_telefono` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transportista_contacto` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transportista_cargo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `transportista_estado` tinyint NOT NULL,
  `transportista_microtime` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `transportistas` (`id_transportistas`, `id_users`, `id_tipo_servicios`, `id_ubigeo`, `transportista_ruc`, `transportista_razon_social`, `transportista_nom_comercial`, `transportista_direccion`, `transportista_correo`, `transportista_telefono`, `transportista_contacto`, `transportista_cargo`, `transportista_estado`, `transportista_microtime`, `created_at`, `updated_at`) VALUES
(1, 1, 2, 1, '12345678901', '123', 'asd', 'asdasdas', 'dasdas@gmail.com', '987456321', 'asdasd', 'asdasd', 1, '1728182791.0205', '2024-10-06 07:46:31', '2024-10-07 19:29:16'),
(2, 1, 1, 1, '09876543211', 'asdasdasd', 'asdasd', 'sdasd', 'asdasd@gmail.com', '987461557', 'asdasf', 'fgsdfsd', 1, '1728182884.0069', '2024-10-06 07:48:04', '2024-10-06 07:48:04'),
(3, 1, 3, 5, '45678912325', 'qweqwq', 'wesdaefwef', 'adfwefwefw', 'weddwed@gmail.com', '963258741', 'efwefr', 'waferge', 1, '1728312719.3752', '2024-10-07 19:51:59', '2024-10-07 19:51:59');
...
(1, 'Eder Alfredo', 'Apagueño Reyna', 'reynaalfredo421@gmail.com', 'superadmin', NULL, NULL, '$2y$12$SzVs4f6gyPoOTubGPTKniOI6.2YAocQp2HdyNkP5ytf2eieU8lYeu', NULL, NULL, NULL, 'mkuaosnLJkiGqvSo5erIQn0PmAPBUVty73BmvbS8icbUe1QQaR1JYKO0BbPm', NULL, NULL, 1, NULL, 956449198, NULL, NULL, '2024-09-17 14:09:24'),
(4, 'Carlos Melendez', 'Bernuy', 'puntostyle05@gmail.com', 'admin', 'uploads/configuration/users/20240907_231301_4.jpg', NULL, '$2y$12$wa3/J4wkejuv3TYYXsoU3uY62tRI4mt16GFlbcdmCxiqzTwi6I2Dy', NULL, NULL, NULL, 'aStyRsnZ35rOgZ8NgU2HUcYeTx79S33eiDdLTNfv1Csu4pghNvoryyDSRQJy', NULL, NULL, 1, NULL, NULL, NULL, '2024-09-08 03:33:39', '2024-09-16 02:06:13');
...
CREATE TABLE `vehiculos` (
  ...
  `vehiculo_capacidad_peso` decimal(10,2) NOT NULL,
  `vehiculo_capacidad_volumen` decimal(10,2) NOT NULL,
  `vehiculo_estado` tinyint NOT NULL,
  `vehiculo_microtime` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `vehiculos` (`id_vehiculo`, `id_users`, `id_transportistas`, `id_tipo_vehiculo`, `vehiculo_placa`, `vehiculo_capacidad_peso`, `vehiculo_capacidad_volumen`, `vehiculo_estado`, `vehiculo_microtime`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 'E3', '13212.00', '16815.00', 1, '1728356104.5787', '2024-10-08 07:55:04', '2024-10-08 19:26:19'),
(2, 1, 1, 2, 'fadas54', '5616.56', '34.24', 1, '1728356232.0193', '2024-10-08 07:57:12', '2024-10-08 07:57:12'),
(3, 1, 2, 2, 'sdasdas asd', '8.00', '5.00', 1, '1728356264.5971', '2024-10-08 07:57:44', '2024-10-08 07:57:44');
...
ALTER TABLE `tipo_servicios`
  ...
  ADD KEY `tipo_servicios_id_users_foreign` (`id_users`);
...
ALTER TABLE `tipo_vehiculos`
  ...
  ADD KEY `tipo_vehiculos_id_users_foreign` (`id_users`);

--
-- Indexes for table `transportistas`
--
ALTER TABLE `transportistas`
  ADD PRIMARY KEY (`id_transportistas`),
  ADD KEY `transportistas_id_users_foreign` (`id_users`),
  ADD KEY `transportistas_id_tipo_servicios_foreign` (`id_tipo_servicios`),
  ADD KEY `transportistas_id_ubigeo_foreign` (`id_ubigeo`);
...
ALTER TABLE `vehiculos`
  ...
  ADD KEY `vehiculos_id_users_foreign` (`id_users`),
  ADD KEY `vehiculos_id_transportistas_foreign` (`id_transportistas`),
  ADD KEY `vehiculos_id_tipo_vehiculo_foreign` (`id_tipo_vehiculo`);
...
--
ALTER TABLE `menus`
  MODIFY `id_menu` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `submenus`
  MODIFY `id_submenu` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `tipo_servicios`
--
ALTER TABLE `tipo_servicios`
  MODIFY `id_tipo_servicios` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tipo_vehiculos`
--
ALTER TABLE `tipo_vehiculos`
  MODIFY `id_tipo_vehiculo` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `transportistas`
--
ALTER TABLE `transportistas`
  MODIFY `id_transportistas` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tipo_servicios`
  ADD CONSTRAINT `tipo_servicios_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id_users`);

--
-- Constraints for table `tipo_vehiculos`
--
ALTER TABLE `tipo_vehiculos`
  ADD CONSTRAINT `tipo_vehiculos_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id_users`);

--
-- Constraints for table `transportistas`
--
ALTER TABLE `transportistas`
  ADD CONSTRAINT `transportistas_id_tipo_servicios_foreign` FOREIGN KEY (`id_tipo_servicios`) REFERENCES `tipo_servicios` (`id_tipo_servicios`),
  ADD CONSTRAINT `transportistas_id_ubigeo_foreign` FOREIGN KEY (`id_ubigeo`) REFERENCES `ubigeos` (`id_ubigeo`),
  ADD CONSTRAINT `transportistas_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id_users`);

--
-- Constraints for table `vehiculos`
--
ALTER TABLE `vehiculos`
  ADD CONSTRAINT `vehiculos_id_tipo_vehiculo_foreign` FOREIGN KEY (`id_tipo_vehiculo`) REFERENCES `tipo_vehiculos` (`id_tipo_vehiculo`),
  ADD CONSTRAINT `vehiculos_id_transportistas_foreign` FOREIGN KEY (`id_transportistas`) REFERENCES `transportistas` (`id_transportistas`),
  ADD CONSTRAINT `vehiculos_id_users_foreign` FOREIGN KEY (`id_users`) REFERENCES `users` (`id_users`);
COMMIT;
