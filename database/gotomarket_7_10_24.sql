...
--
-- Host: localhost:3306
-- Generation Time: Oct 07, 2024 at 04:42 PM
...
--
ALTER TABLE `submenus`
  MODIFY `id_submenu` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tipo_servicios`
--
ALTER TABLE `tipo_servicios`
  MODIFY `id_tipo_servicios` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
