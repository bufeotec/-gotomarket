<div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 mb-3 text-end">
            <a class="btn btn-sm bg-primary text-white ms-2"><i class="fa-solid fa-pen-to-square"></i> Editar</a>
            <a class="btn btn-sm bg-success text-white ms-2"><i class="fa-solid fa-check"></i> Aprobar</a>
            <a class="btn btn-sm bg-warning text-black ms-2"><i class="fa-solid fa-ban"></i> Anular</a>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body mt-3">
                            ...
                            <p>RUC <strong>{{$listar_info->transportista_ruc}}</strong></p>
                            <p>CAL.CALLE 1 MZA. X LOTE. 4V INT. C COO. LAS VERTIENTES DE TABLADA DE LURÍN LIMA - LIMA - VILLA EL SALVADOR</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body mt-3">
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-3 col-sm-12 mb-2">
                                    ...
                                    <p>S/ {{$general->formatoDecimal($listar_info->despacho_costo_total)}}</p>
                                </div>
                                <div class="col-lg-2 col-md-3 col-sm-12 mb-2">
