                                ...
                                <div class="card">
                                    <div class="card-body d-flex justify-content-between">
                                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3 px-3">
                                            <h6>Departamento (*)</h6>
                                            <select class="form-select" name="id_departamento" id="id_departamento" wire:model="id_departamento" wire:change="calcularTarifa" wire:input="listar_provincias">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-12 mb-3 px-3">
                                            <h6>Provincia (*)</h6>
                                            <select class="form-select" name="id_provincia" id="id_provincia" wire:model="id_provincia" wire:change="calcularTarifa" wire:input="listar_distritos" {{ empty($provincias) ? 'disabled' : '' }}>
                                                <option value="">Seleccionar...</option>
