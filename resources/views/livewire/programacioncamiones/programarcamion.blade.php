                        ...
                        <div class="radio-button-container">
                            @foreach($listar_tipo_servicio as $tipo)
                                <div class="radio-button">
                                    <input type="radio" id="tipo_{{ $tipo->id_tipo_servicios }}"
                                           wire:change="resetearCampoTipoServicio"
                                           name="id_tipo_servicios"
                                           class="radio-button__input"
                                           wire:model.lazy="id_tipo_servicios"
                                           value="{{ $tipo->id_tipo_servicios }}"
                            ...
                            <!-- opción "MIXTO" -->
                            <div class="radio-button">
                                <input type="radio" id="tipo_mixto" wire:change="resetearCampoTipoServicio"
                                       name="id_tipo_servicios"
                                       class="radio-button__input"
                                       wire:model.lazy="id_tipo_servicios"
                                       value="MIXTO"
                                       @if($id_tipo_servicios == 'MIXTO') checked @endif />
                                ...
                                @foreach($vehiculosSugeridos as $vehiculo)
                                    <label class="circulo-vehiculo-container m-2 {{ $vehiculo->tarifa_estado_aprobacion == 0 ? 'no-aprobado' : '' }}">
                                        @if($vehiculo->tarifa_estado_aprobacion == 1)
                                            <input type="radio" name="vehiculo" class="vehiculo-radio" value="{{ $vehiculo->id_vehiculo }}" wire:model="selectedVehiculo" />
                                        @endif
...
{{--    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">--}}
    ...
    <style>
        ...
        .vehiculo-radio:checked + svg + .circulo-vehiculo {
            background-color: #c8eac9;
        }
        .circulo-vehiculo-container:hover .circulo-vehiculo {
            background-color: #FFFFFF;
        }
        .circulo-vehiculo-container input[type="radio"] {
            display: none;
        }
        .circulo-vehiculo {
            width: 110px;
        ...
        .tarifa-container, .peso-container, .placa-container {
            text-align: center;
        }
        .tarifa-monto {
            font-size: 16px;
        ...
        .circulo-vehiculo-container.no-aprobado .circulo-vehiculo {
            background-color: #ffcccc;
            cursor: not-allowed;
        }
        .circulo-vehiculo-container.no-aprobado input[type="radio"] {
            display: none;
        }
