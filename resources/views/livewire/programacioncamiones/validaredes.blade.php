                                    ...
                                    <x-slot name="tbody">
                                        ...
                                        <span class="d-block tamanhoTablaComprobantes">
                                            {{ $factura->guia_direc_entrega }}
                                                ...
                                                <td>
                                                    <x-btn-accion class="btn bg-success btn-sm text-white" wire:click="cambio_estado('{{ base64_encode($factura->id_guia) }}', 3)"
                                                                  data-bs-toggle="modal" data-bs-target="#modalPrePro">
                                                        <x-slot name="message">
